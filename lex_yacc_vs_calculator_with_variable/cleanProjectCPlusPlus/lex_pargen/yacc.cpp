	...
	case 8:
		{
			...
			{
#line 55 ".\\yacc.y"
(*(YYSTYPE YYFAR*)yyvalptr) = sym_table.getValue(yyattribute(1 - 1));
#line 295 "yacc.cpp"
			}
		}
		break;
	case 9:
		{
			...
			{
#line 56 ".\\yacc.y"
sym_table.setValue(yyattribute(1 - 3), yyattribute(3 - 3)); (*(YYSTYPE YYFAR*)yyvalptr)=yyattribute(3 - 3); 
#line 308 "yacc.cpp"
			}
		}
		break;
...
void YYPARSERNAME::yytables()
{
	...
	static const yystateaction_t YYNEARFAR YYBASED_CODE stateaction[] = {
		...
		{ 0, 0, YYAT_DEFAULT, 15 },
		{ 0, 0, YYAT_REDUCE, 11 },
		{ -264, 1, YYAT_REDUCE, 12 },
		{ 0, 0, YYAT_DEFAULT, 15 },
		{ 0, 0, YYAT_REDUCE, 2 },
		{ 0, 0, YYAT_REDUCE, 3 },
		{ -248, 1, YYAT_DEFAULT, 11 },
		{ 0, 0, YYAT_REDUCE, 10 },
		{ 0, 0, YYAT_DEFAULT, 15 },
		{ -257, 1, YYAT_ERROR, 0 },
		{ 0, 0, YYAT_DEFAULT, 15 },
